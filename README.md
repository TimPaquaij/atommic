...
Access the API Documentation [here](https://atommic.readthedocs.io/en/latest/modules.html)
...
1. Karkalousos, D., Išgum, I., Marquering, H., Caan, M. W. A., (2023). MultiTask Learning for accelerated-MRI Reconstruction and Segmentation of Brain Lesions in Multiple Sclerosis. In Proceedings of Machine Learning Research (Vol. 078). [Link](https://openreview.net/forum?id=ci2Fg31H0T)
