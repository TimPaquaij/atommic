...
# go inside projects/ATOMMIC_paper/MTL/ folder, find all files inside any subfolder and replace parent_data_dir with the given parent_data_dir_skmtea
find projects/ATOMMIC_paper/MTL/ -type f -exec sed -i "s|parent_data_dir|${parent_data_dir_skmtea}|g" {} +
# go inside projects/ATOMMIC_paper/SEG/ folder, find all files inside any subfolder and replace parent_data_dir with the given parent_data_dir_skmtea
find projects/ATOMMIC_paper/SEG/ -type f -exec sed -i "s|parent_data_dir|${parent_data_dir_skmtea}|g" {} +
# go inside projects/ATOMMIC_paper/SEG/ folder, find all files inside any subfolder and replace parent_data_dir with the given parent_data_dir_skmtea
find projects/ATOMMIC_paper/qMRI/ -type f -exec sed -i "s|parent_data_dir|${parent_data_dir_ahead}|g" {} +
