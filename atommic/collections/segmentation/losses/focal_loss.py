...
#             loss = self.softmax_focal_loss(input, target, self.gamma, self.alpha)
#         else:
#             loss = self.sigmoid_focal_loss(input, target, self.gamma, self.alpha)
#
