...
class MTLRSOBlock(torch.nn.Module):
    """Implementation of a Multi-Task Learning for MRI Reconstruction and Segmentation (MTLRSO) block, as presented in
    [Karkalousos2023]_.
    ...
    def __init__(
        ...
        object_detection_module_params:Dict,
        input_channels: int,
    ...
    def forward(  # noqa: MC0001
        ...
        """Forward pass of :class:`MTLRSOBlock`.
