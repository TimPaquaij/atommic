    ...
    def _setup_dataloader_from_config(cfg: DictConfig) -> DataLoader:
        ...
        if cfg.get("params_json", None):
            ...
            dataset1 = dataloader(
                ...
                median_beat_dir = cfg.get("median_beat_dir", None),
                secondary_median_beat_dir = cfg.get("secondary_median_beat_dir", None),
                median_load_params=cfg.get("median_load_params", None),
