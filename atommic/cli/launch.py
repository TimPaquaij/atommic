...
def main(cfg: DictConfig):  # noqa: MC0001
    ...
    if model_name == "CASCADENET":
        ...
        raise NotImplementedError(
            f"{model_name} is not implemented in atommic."
    ...
    if cfg.get("pretrained", None):
        ...
        if "https://huggingface.co" in checkpoint:
            checkpoint = model.from_pretrained(
                f'{checkpoint.replace(".atommic", ".ckpt")}', return_only_atommic_model_file_in_cache=True
            )
